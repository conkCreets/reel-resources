...
@Mod(ReelResources.MODID)
public class ReelResources {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "reelresources";
    ...
    // Creates a creative tab with the id "reelresources:example_tab" for the example item, that is placed after the combat tab
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("example_tab", () -> CreativeModeTab.builder()
            .title(Component.translatable("itemGroup.reelresources")) //The language key for the title of your CreativeModeTab
    ...
    public ReelResources(IEventBus modEventBus, ModContainer modContainer) {
